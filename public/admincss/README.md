...
**Preview on [ Patna Car Wash](https://adminlte.io/themes/v3)**

## Looking for Premium Templates?

 Patna Car Wash just opened a new premium templates page. Hand picked to ensure the best quality and the most affordable
...
AdminLTE is an open source project by [ Patna Car Wash](https://adminlte.io) that is licensed under [MIT](https://opensource.org/licenses/MIT).
 Patna Car Wash reserves the right to change the license of future releases.
