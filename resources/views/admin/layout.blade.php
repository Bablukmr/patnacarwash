...
<body class="hold-transition sidebar-mini layout-fixed">
    <div class="wrapper">
        ...
        <nav class="main-header navbar navbar-expand navbar-white navbar-light">
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item d-none d-sm-inline-block">
                    <a href="http://patnacarwash.com/" class="nav-link">Website</a>
                </li>
            </ul>
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <nav class="mt-2">
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu">
                    ...
                    <li class="nav-item">
                        <a href="{{ route('admin.regular-clients-list') }}" class="nav-link">
                            <i class="nav-icon fas fa-user-tie"></i>
                            <p>Regular Booking</p>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="{{ route('admin.logout') }}" class="nav-link">
                         ...
                         <li class="nav-item">
                          <a class="nav-link">
                        <i class="nav-icon fas fa-user-tie"></i>
                        <p>Name: {{ Auth::guard('admin')->user()->name ?? 'Guest' }}</p>
                           </a>
                    </li>
                </ul>
            </nav>
    ...
    <footer class="main-footer">
        <strong>Copyright &copy; 2025 <a href="https://patnacarwash.com/" target="_blank"> Patna Car Wash</a>.</strong>
        All rights reserved.
