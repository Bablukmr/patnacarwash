                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            ...
                            <a href="{{ route('regular-clients-list.create') }}" class="btn btn-primary float-right">Assign Regular Client</a>
                        </div>
                        <!-- /.card-header -->
                        <div class="card-body">
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ $client->booking->address }}</td>
                                        <td>{{ $client->employee->name ?? 'N/A' }}</td>
                                        <td>{{ $client->booking->created_at }}</td>
